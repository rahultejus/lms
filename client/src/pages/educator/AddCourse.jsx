      ...
      <div className='flex items-center justify-between flex-wrap'>
        ...
        <div className='flex md:flex-row flex-col items-center gap-3'>
          ...
          <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
            ...
            <input type="file" id="thumnailImage" onChange={e=>setImage(e.target.files[0])} accept='image/*' hidden />
        ...
        <div>
           ...
           <div className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer mt-3'
           ...
           { showPopup &&(
             <div className='fixed inset-0  flex items-center justify-center bg-gray-800 bg-opacity-50'>
              ...
              <button type='button' className='w-full bg-blue-400 text-white px-4 py-2
              rounded' onClick={addLecture}>Add</button>
